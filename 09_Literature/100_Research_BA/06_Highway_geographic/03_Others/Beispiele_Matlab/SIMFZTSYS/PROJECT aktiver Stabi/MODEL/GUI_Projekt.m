...
set_param('MODELL_aktiver_Stabi/GESCHWINDIGKEIT', 'Value', num2str(neuerSliderWert))
...
if button_state == get(hObject,'Max')
     ...
     set_param('MODELL_aktiver_Stabi/STABIMODE 1', 'Value', '1')
     set(handles.text2, 'String', 'Stabi verbunden')
elseif button_state == get(hObject,'Min')
	set(handles.text2,'BackgroundColor',[0,1,0])
    set_param('MODELL_aktiver_Stabi/STABIMODE 1', 'Value', '0')
    set(handles.text2, 'String', 'Stabi getrennt')
    set_param('MODELL_aktiver_Stabi/STABIMODE 2', 'Value', '0')
    set(handles.text3, 'String', 'Pneumatikzylinder inaktiv')
    set(handles.text3,'BackgroundColor',[0,1,0])
end
...
if button_state == get(hObject,'Max')
     ...
     set_param('MODELL_aktiver_Stabi/STABIMODE 2', 'Value', '1')
     set_param('MODELL_aktiver_Stabi/STABIMODE 1', 'Value', '1')
     set(handles.text2, 'String', 'Stabi verbunden')
     set(handles.text2,'BackgroundColor',[1,0,0])
...
if button_state == get(hObject,'Max')
     ...
     set_param('MODELL_aktiver_Stabi/STRECKE', 'Value', '1')
     set(handles.text4, 'String', 'Kurve')
elseif button_state == get(hObject,'Min')
	set(handles.text4,'BackgroundColor',[0,1,0])
    set_param('MODELL_aktiver_Stabi/STRECKE', 'Value', '0')
    set(handles.text4, 'String', 'Gerade')
end
...
if button_state == get(hObject,'Max')
     ...
     set_param('MODELL_aktiver_Stabi/STRECKE1', 'Value', '1')
     set(handles.text5, 'String', 'Schlagloch vorhanden')
elseif button_state == get(hObject,'Min')
	set(handles.text5,'BackgroundColor',[0,1,0])
    set_param('MODELL_aktiver_Stabi/STRECKE1', 'Value', '0')
    set(handles.text5, 'String', 'Schlagloch nicht vorhanden')
end
...
sim('MODELL_aktiver_Stabi')
set_param('MODELL_aktiver_Stabi/Zeitverlauf','open','on') 
